...
namespace MobileDashboard
{
    public class SlidingTabStrip : LinearLayout
    {
        ...
        //Tab coloriser
        private SlidingTabScrollView.TabColorizer mCustomColorizer;
        ...
        protected override void OnDraw(Canvas canvas)
        {
            ...
            SlidingTabScrollView.TabColorizer tabColorizer = mCustomColorizer != null ? mCustomColorizer : mDefaultTabColorizer;
