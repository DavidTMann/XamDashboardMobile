...
namespace MobileDashboard
{
    ...
    {
        private const int TITLE_OFF_DIPS = 24;
        ...
        public SlidingTabScrollView(Context context, IAttributeSet attrs, int defaultStyle) : base(context,attrs,defaultStyle)
        {
            ...
            //Make sure tab strip fill the view
            FillViewport = true;
            this.SetBackgroundColor(Android.Graphics.Color.Rgb(0xE5, 0xe5, 0xe5)); //grey

            mTitleOffSet = (int)(TITLE_OFF_DIPS * Resources.DisplayMetrics.Density);
        ...
        private void Value_PageScrolled(object sender, ViewPager.PageScrolledEventArgs e)
        {
            ...
            {
                //if any of these conditions apply no need to scroll
                return;
            }
        ...
        private void PopulateTabStrip()
        {
            ...
            for (int i = 0; i < adapter.Count; i++)
            {
                ...
                tabView.Text = ((SlidingTabsFragment.SamplePageAdapter)adapter).GetHeaderTitle(i);
